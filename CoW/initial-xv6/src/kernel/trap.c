...
void usertrap(void)
{
    ...
    {
        uint64 va_for_page_fault = ((uint64)r_stval());
        ...
        {
            // printf("The process is trying to access some invalid memory address");
            p->killed = 1;
            exit(-1);
        }
        ...
        uint64 virtual_addr = PGROUNDDOWN((uint64)r_stval());
